...
public class ScenicMainActivity extends AppCompatActivity {
        ...
        navigation_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.action_home) {
                    // 按下「景點頁」要做的事
                    Intent i = new Intent(ScenicMainActivity.this, Menu.class);
                    startActivity(i);
                    return true;
                }
                    ...
                    // 按下「會員資訊」要做的事
                    if (Contants.uid=="0"){
                        AlertDialog.Builder builder =new AlertDialog.Builder(ScenicMainActivity.this);
                        ...
                        Intent i = new Intent(ScenicMainActivity.this, User_info.class);
                        startActivity(i);
                    }
                    return true;
                }
                ...
                // 按下「推薦拍照」要做的事
                Intent i = new Intent(ScenicMainActivity.this, Emulate_picture.class);
                startActivity(i);
                return true;
            }
    ...
    private void search(String newtext)
    {
        ...
        scenics.clear();
        //SELECT
        Cursor c=helper.selectScenic(newtext);
        //LOOP THRU THE DATA ADDING TO ARRAYLIST
        while (c.moveToNext())
        {
            int id=c.getInt(0);
